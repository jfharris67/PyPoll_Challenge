...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes_county > highest_county_votes) and (vote_county_percentage > highest_county_percentage):
            highest_county_votes = votes_county
            highest_county_percentage = vote_county_percentage
            highest_county_turnout = county_name

    # 7: Print the county with the largest turnout to the terminal.
    highest_county_summary = (
        f"----------------------------------------\n"
        f"Best County Turnout: {highest_county_turnout}\n"
        f"----------------------------------------\n")
